            ...
            <div className="block3">
                <div className="blockParagraph">
                    ...
                    <div className="buttons">
                        <a href="https://github.com/unnamedNasaSpaceApps/Moonquake-web" target="_blank" rel="noopener noreferrer"><input type="button" value="Web code" /></a>
                        <a href="https://github.com/unnamedNasaSpaceApps/Moonquake-Map" target="_blank" rel="noopener noreferrer"><input type="button" value="Sim code" /></a>
                    </div>
                </div>
